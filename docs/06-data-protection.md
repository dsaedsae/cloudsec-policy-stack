...
> 가 적절하다. 여기 aescbc는 2-키 회전 런북([runbooks/02](https://github.com/dsaedsae/cloudsec-policy-stack/blob/master/runbooks/02-key-rotation.md))을 보이기 위한 선택이며, 실 적용 시 cipher는 aesgcm/KMS로.
