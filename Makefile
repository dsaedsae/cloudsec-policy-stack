...
m11:  ## grade M11 (BPF-LSM exec-allowlist policy, no-cluster static; live = labs/m11/grade.sh, SKIP-prone on kind)
	$(PY) labs/m11/grade.py
...
.PHONY: help venv setup doctor progress test m0 m1 m6 m7 m10 m11 report brief docs site serve up verify down
